...
if __name__ == '__main__':
    ...
    if args.example is None:
        create_views(db)
    elif args.example == "workflows":
        # create the views for the autopilot example
        create_views(db, design_doc_name='ddcal', logic_appendix=' && doc.workflow == "ddcal"')
        create_views(db, design_doc_name='imaging', logic_appendix=' && doc.workflow == "imaging"')
    else:
        exit('Unknown example. Can only create extra views for example "workflows".')
